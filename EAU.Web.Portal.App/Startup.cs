...
namespace EAU.Web.Portal.App
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClientWithAuthenticationHanlder(WAIS.Integration.EPortal.Common.HttpClientNames.WAISIntegrationEAUApi,
                (sp, client) =>
                {
                    client.BaseAddress = new Uri(Configuration.GetSection("EAU").GetValue<string>("GL_EAU_WAIS_INTEGRATION_API"));
                });
            services.AddHttpClientWithAuthenticationHanlder(WAIS.Integration.EPortal.Common.HttpClientNames.WAISDocumentViewer,
                (sp, client) =>
                {
                    client.BaseAddress = new Uri(Configuration.GetSection("EAU").GetValue<string>("GL_EAU_WAIS_INTEGRATION_API"));
                });
            ...
            services.AddHttpClientWithAuthenticationHanlder(WAIS.Integration.EPortal.Common.HttpClientNames.WAISNomenclaturesApi,
                (sp, client) =>
                {
                    client.BaseAddress = new Uri(Configuration.GetSection("EAU").GetValue<string>("GL_EAU_WAIS_NOMENCLATURES_API"));
                });
            services.AddWAISNomenclaturesClient(WAIS.Integration.EPortal.Common.HttpClientNames.WAISNomenclaturesApi);
