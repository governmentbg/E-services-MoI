...
import { DeliveryChannel, eauAuthenticationService, ResourceHelpers } from "eau-core";
import { action, runInAction } from "mobx";
import moment from 'moment';
import { Nomenclatures } from "../cache/Nomenclatures";
import { ApplicationFormVMBase, ApplicationType, DocumentModes, ElectronicServiceAuthorQualityType, EntityBasicData, IdentityDocumentBasicDataVM, IdentityDocumentType, PersonAndEntityChoiceType, PersonBasicDataVM, PersonIdentifier, PersonIdentifierChoiceType, PersonNames, ServiceApplicantReceiptDataAddress, ServiceApplicantReceiptDataUnitInAdministration, ServiceResultReceiptMethods, ServiceTermType, UnitInfo } from "../models";
...
import { ErrMsgCodesConstants } from "../validations/ErrMsgCodesConstants";
...
export abstract class ApplicationFormManagerBase<TApp extends ApplicationFormVMBase>
    extends DocumentFormManagerBase<TApp>
    implements IApplicationFormManager {
