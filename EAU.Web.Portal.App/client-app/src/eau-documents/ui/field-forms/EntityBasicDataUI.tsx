        ...
        return (
            <div className="row">
                ...
                <div className="form-group col col-sm-6">
                    {
                        this.props.documentFormManager.applicationType == ApplicationType.AppForRemoveInvalidData || this.props.documentFormManager.additionalData?.disabledEntityIdentifier == "true"
