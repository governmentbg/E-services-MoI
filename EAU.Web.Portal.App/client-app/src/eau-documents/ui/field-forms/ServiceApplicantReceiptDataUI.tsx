...
import { ServiceApplicantReceiptDataUnitInAdministration, ServiceApplicantReceiptDataVM, ServiceResultReceiptMethods } from "../../models/ModelsAutoGenerated";
        ...
        if (deliveryWays && deliveryWays.length > 0) {
            this.deliveryWayItems = ArrayHelper.queryable.from(deliveryWays).select(el => {
                let tmpItem = new SelectListItem({
                    selected: el.deliveryChannelID == that.model.serviceResultReceiptMethod,
                ...
                if (deliveryWays.length == 1) {
                    ...
                    that.model.serviceResultReceiptMethod = el.deliveryChannelID;
                }
