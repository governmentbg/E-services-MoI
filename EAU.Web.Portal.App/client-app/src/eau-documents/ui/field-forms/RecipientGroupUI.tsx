...
@observer class RecipientGroupUIImpl extends EAUBaseComponent<RecipientGroupUIProps, RecipientGroupVM> {
    ...
    renderEdit(): JSX.Element {
        if (this.model) {
            ...
            return (<>
                    <AuthorWithQualityUI {...this.bind(m => m.authorWithQuality)} />
                    {this.hideRecipientUI() ? null :
                        <ElectronicServiceRecipientUI {...this.bind(m => m.recipient)}
                            viewMode={this.model.authorWithQuality.selectedAuthorQuality == ElectronicServiceAuthorQualityType.Personal ? ViewMode.Display : ViewMode.Edit} />
                    }
                </>);
