...
export class PersonAddressValidator extends EAUBaseValidator<PersonAddress, DocumentFormValidationContext> {
    constructor() {
        ...
        //this.ruleFor(m => m.streetText).notEmpty()
        //    .withMessage(ResourceHelpers.formatErrorMessage(ErrMsgCodesConstants.DefaultNotEmptyErrorMessage, new PersonAddress(), 'streetText'));
