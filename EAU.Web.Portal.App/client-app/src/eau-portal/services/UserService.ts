import { EAUBaseDataService, UserAuthentication } from 'eau-core';
import { UserAuthenticationInfo } from '../models/ModelsAutoGenerated';
import { UserInputModel, UserRegistrationResult, UserConfirmRegistrationResult, CompleteForgottenPasswordModel } from '../models/userModels';
