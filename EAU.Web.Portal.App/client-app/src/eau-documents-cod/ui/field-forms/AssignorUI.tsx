...
import { attributesClassFormControlReqired, attributesClassFormControlRequiredLabel, EAUBaseComponent, ResourceHelpers, attributesClassFormControlLabel, attributesClassFormControlReadOnly } from "eau-core";
import { PersonIdentifierChoiceType, RegiXDataService } from "eau-documents";
import { action, runInAction } from "mobx";
import { observer } from "mobx-react";
import React from "react";
import { ContractAssignor, AssignorPersonEntityType, PersonAssignorData, EntityAssignorData, GuardedType } from "../../models/ModelsAutoGenerated";
import { ObjectHelper } from "cnsys-core";

@observer export class AssignorUI extends EAUBaseComponent<BaseProps, ContractAssignor>{
    ...
    renderEditContent() {
        ...
        if (this.model.assignorPersonEntityType == AssignorPersonEntityType.Person) {
            return <PersonAssignorDataUI {...this.bind(x => x.personAssignorData)} showType={false} isGuardedPerson={false} />
        }
...
@observer export class PersonAssignorDataUI extends EAUBaseComponent<PersonAssignorDataProps, PersonAssignorData>{
    ...
    renderEdit(): JSX.Element {
        return <div className="row">
            <div className={this.props.showType === true ? "form-group col-lg-7 col-xl-6" : "form-group col-12 col-lg-6 col-xl-7"}>               
