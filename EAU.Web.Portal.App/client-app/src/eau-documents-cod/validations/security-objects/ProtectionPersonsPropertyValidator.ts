...
export class ProtectionPersonsProperty_NValidator
    ...
    constructor() {
        ...
        this.ruleFor(x => x.districtCode).notEmpty()
            .withMessage(ResourceHelpers.formatErrorMessage(ErrMsgCodesConstants.DefaultNotEmptyErrorMessage, new ProtectionPersonsProperty(), 'districtCode'));

        this.ruleFor(x => x.controlType).notEmpty()
            .withMessage(ResourceHelpers.formatErrorMessage(ErrMsgCodesConstants.DefaultNotEmptyErrorMessage, new ProtectionPersonsProperty(), 'controlType'));

        this.ruleFor(x => x.accessRegimeType).notEmpty()
            .withMessage(ResourceHelpers.formatErrorMessage(ErrMsgCodesConstants.DefaultNotEmptyErrorMessage, new ProtectionPersonsProperty(), 'accessRegimeType'));
