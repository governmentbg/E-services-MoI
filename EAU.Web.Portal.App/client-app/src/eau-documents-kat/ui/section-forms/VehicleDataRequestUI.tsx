...
import { ApplicationFormManagerProps, FieldFormUI, withDocumentFormManager, Nomenclatures, AISKATNomenclatureItem, ApplicationType } from "eau-documents";
    ...
    renderEdit(): JSX.Element {
        return (
            <>
                ...
                <FieldFormUI title={this.getResource('DOC_GL_ProvidingRefusalDocument_L')} required={true}>
