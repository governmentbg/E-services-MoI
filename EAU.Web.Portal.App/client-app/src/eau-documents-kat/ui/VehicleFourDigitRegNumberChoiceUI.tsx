...
import { VehicleTypeCode, FourDigitSearchCriteria, IFourDigitsSearchResult, IPlateStatusResult, PlateStatus, FourDigitSearchTypes } from "../models/FourDigitSearchCriteria";
