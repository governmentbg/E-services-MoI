...
import { ErrMsgCodesConstants } from "eau-documents";
...
export class VehicleRegistrationDataValidator extends EAUBaseValidator<VehicleRegistrationDataVM, DocumentFormValidationContext> {
    constructor() {
        ...
        this.ruleFor(m => m.identificationNumber).length(1, 17)
            .withMessage(ResourceHelpers.formatErrorMessage(ErrMsgCodesConstants.FieldCanNotContainsMoreThanSymbols, new VehicleRegistrationDataVM(), 'identificationNumber', 17))
