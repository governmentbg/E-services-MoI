...
export const attributesClassFormControlReqired = { className: 'form-control', required: true };
...
export const attributesTypePasswordFormControlRequired = { type: "password", className: "form-control", required: true }
...
export abstract class EAUBaseComponent<TProps extends BaseProps, TModel extends IModelErrors> extends BaseComponent<TProps, TModel> {
    ...
    protected textDisplay(propValue: string, model: IModelErrors, propName: string): JSX.Element {
        if (ObjectHelper.isNullOrUndefined(model)) return null;
        ...
        return (
            <>
                <p className="field-text">{propValue}</p>
