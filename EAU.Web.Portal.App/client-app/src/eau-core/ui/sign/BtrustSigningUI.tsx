                            ...
                            {this.waySendRemoteRequest == BY_EGN_LNCH ?
                                <div className="row">
                                    <div className="col-md-6 col-lg-4">
                                        <div className="row">
                                            <div className="col">
                                                <label htmlFor="PERSON_ID" className="form-control-label">{this.getResource('GL_PERSON_ID_L')}</label>
                                            </div>
                                        </div>
                                        <div className="row">
                                            <div className="form-group col">
                                                <input id="PERSON_ID" type="text" className="form-control" value={this.egnLnch ? this.egnLnch : ''} onChange={this.egnLnchChange} />
                                                {ObjectHelper.isStringNullOrEmpty(this.egnLnchError) ? null : <ul id="egnLnchError" className="invalid-feedback"><li key={0}><i className="ui-icon ui-icon-error mr-1"></i>{this.egnLnchError}</li></ul>}
                                            </div>
