...
class PageRoute {
    ...
    private getPageRouteNodes(path: string,
        nodes?: { disabled: boolean; path: string; pathPattern: string; text: ((routeParams: any) => Promise<string>) | string, showMainNodeOnly?: boolean, pathParams: any, skipBreadcrumb?: boolean }[]): { disabled: boolean; path: string; pathPattern: string; text: ((routeParams: any) => Promise<string>) | string, showMainNodeOnly?: boolean, pathParams: any, skipBreadcrumb?: boolean }[] {
        if (!nodes) {
            nodes = [];
        }
