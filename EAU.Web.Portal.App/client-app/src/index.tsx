...
import { Constants, Layout, MyEServicesUI, MyEPaymentsUI, KatObligationsUI, MyEServiceInstanceUI, SiteMapUI, CmsUI, SearchsUI, ServicesUI, UsersUI, SessionTimeoutUI, TooManyRequestsUI, UnauthenticatedPageUI, PageNotFoundUI } from 'eau-portal';
import { ApplicationProcessUI, PreviewDocumentProcessUI } from 'eau-services-document-processes';
...
const App = ({ user }) => {
    ...
    return <Layout user={user}>
        <Switch>
            ...
            <Route key={4} path={Constants.PATHS.Search} component={SearchsUI} />
            ...
            <Route key={14} path={Constants.PATHS.KatObligations} component={KatObligationsUI} />
            <Route key={15} path={Constants.PATHS.SiteMap} component={SiteMapUI} />
            <Route key={16} path={Constants.PATHS.VideoLessons} component={CmsUI} />
            <Route key={17} path={Constants.PATHS.AccessFunction} component={CmsUI} />
            <Route key={18} path={CoreConstants.PATHS.DocumentPreview} component={PreviewDocumentProcessUI} />
            <Route key={19} path={Constants.PATHS.TooManyRequestsUI} component={TooManyRequestsUI} />
            {/**��������, ������� ��� ������������ ����������.*/}
            {authorizedPages.map((route, index) => <Route key={`authorized-${index}`} path={route.path} component={user ? route.component : UnauthenticatedPageUI} />)}

            {/**��������, ������� ��� �������������� ����������.*/}
            {user ? <Redirect key={25} from={Constants.PATHS.SessionTimeout} to={Constants.PATHS.Home} /> : <Route key={24} path={Constants.PATHS.SessionTimeout} component={SessionTimeoutUI} />}

            <Route key={26} component={PageNotFoundUI} />
        </Switch>
    </Layout>
}
