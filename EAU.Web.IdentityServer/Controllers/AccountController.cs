...
namespace EAU.Web.IdentityServer.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Login(string returnUrl, string errorID, string returnReason)
        {            
               ...
               [FromServices] IEAUClaimsHelper claimsHelper, CancellationToken cancellationToken)
        {
            ...
            var res = await usersService.RegisterUserCertificateAuthenticationAsync(clientCertificate,
                        int.Parse(userAccessor.User.ClientID), HttpContext.Connection.RemoteIpAddress, cancellationToken);
