          ...
          <thead width="100%">
            ...
            <tr style="border: none;">
              <th style="border: none; font-size: 14px;">
                ЗАЯВЛЕНИЕ<br/> за издаване на документ за самоличност на български граждани
              </th>
              <td>
                &#160;
              </td>
                ...
                <table width="100%" align="center" style="border-collapse: collapse;font-size: 9px;" border="1" cellspacing="0">
                    ...
                    <td align="center" colspan="3">
                      <table width="100%" style="font-size:9px;">
                        <tr>
                          ...
                          <td>
                            <xsl:choose>
                              <xsl:when test="MOI:ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensData/APIDBS:Person/PI:MaritalStatus='357'">
                                <u>
                                  <b>женен/омъжена</b>
                                </u>
                              </xsl:when>
                          ...
                          <td>
                            <xsl:choose>
                              <xsl:when test="MOI:ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensData/APIDBS:Person/PI:MaritalStatus='358'">
                                <u>
                                  <b>разведен/а</b>
                                </u>
                              </xsl:when>
                          ...
                          <td>
                            <xsl:choose>
                              <xsl:when test="MOI:ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensData/APIDBS:Person/PI:MaritalStatus='355'">
                                <u>
                                  <b>вдовец/вдовица</b>
                                </u>
                              </xsl:when>
                          ...
                          <td>
                            <xsl:choose>
                              <xsl:when test="MOI:ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensData/APIDBS:Person/PI:MaritalStatus='356'">
                                <u>
                  ...
                  <tr>
                    <td align="left" colspan="4">
                      <b>
                        Долуподписаните родители, настойници, попечители или други законни представители <br /> заявяваме издаването на документ за самоличност
                      </b>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="left" colspan="4">
                      ...
                      <br/>Попълват се замо ако заявения/те документи за самоличност ще се получава/т от упълномощено лице
                  ...
                  <tr>
                    <td align="center" colspan="3">
                      <table width="100%" style="font-size:9px;">
                        <tr>
                          <td>
                            <em>Полето се попълва само от лица, живеещи предимно в чужбина при подаване на заявление за лична карта.</em>
                          </td>
                        </tr>
                        <tr>
                          <td>
