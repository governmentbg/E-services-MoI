...
namespace EAU.BDS.Documents.Models.Mapping
{
    public class EAUBDSDocumentsAutoMapperProfile : Profile
    {
        ...
        private void CreateDomainToViewModelMap()
        {
            ...
            CreateMap<OtherIndormationConnectedWithIssuedBulgarianIdentityDocuments, OtherIndormationConnectedWithIssuedBulgarianIdentityDocumentsVM>();
            ...
            CreateMap<DocumentToBeIssuedFor, DocumentToBeIssuedForVM>()
                .AfterMap((s, d, ctx) =>
                {
                    if (s.Item != null)
                    {
                        ...
                        {
                            d.ChooseIssuingDocument = IssueDocumentFor.OtherIndormationConnectedWithIssuedBulgarianIdentityDocuments;
                            d.OtherIndormationConnectedWithIssuedBulgarianIdentityDocuments = s.Item != null ? ctx.Mapper.Map<OtherIndormationConnectedWithIssuedBulgarianIdentityDocumentsVM>(s.Item) : null;
                        }
                    }
                    else
                    {
            ...
            CreateMap<ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensData, ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensDataVM>()
                .AfterMap((s, d, ctx) =>
                {
                    d.Person = ctx.Mapper.Map<PersonData, PersonDataVM>(s.Person);
        ...
        private void CreateViewToDomainModelMap()
        {
            ...
            CreateMap<OtherIndormationConnectedWithIssuedBulgarianIdentityDocumentsVM, OtherIndormationConnectedWithIssuedBulgarianIdentityDocuments>();
            ...
            CreateMap<DocumentToBeIssuedForVM, DocumentToBeIssuedFor>()
                .AfterMap((s, d, ctx) =>
                {
                    ...
                    else if (s.ChooseIssuingDocument == IssueDocumentFor.OtherIndormationConnectedWithIssuedBulgarianIdentityDocuments)
                        d.Item = ctx.Mapper.Map<OtherIndormationConnectedWithIssuedBulgarianIdentityDocumentsVM, OtherIndormationConnectedWithIssuedBulgarianIdentityDocuments>(s.OtherIndormationConnectedWithIssuedBulgarianIdentityDocuments);
                });
            ...
            CreateMap<ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensDataVM, ApplicationForIssuanceOfPersonalDocumentsOfBulgarianCitizensData>()
                .AfterMap((s, d, ctx) =>
                {
                    d.Person = ctx.Mapper.Map<PersonDataVM, PersonData>(s.Person);
