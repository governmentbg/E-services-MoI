                ...
                When(m => m.Identifier != null
                    ...
                    , () =>
                    {
                        EAURuleFor(m => m.IdentityDocument)
                            .RequiredField()
                            .EAUInjectValidator("OnlyNumberWith2Letters"); //IdentityDocumentBasicDataValidator
                    })
                .Otherwise(() =>
                {
                    EAURuleFor(m => m.IdentityDocument).EAUInjectValidator("OnlyNumberWith2Letters"); //IdentityDocumentBasicDataValidator
                });
            });
