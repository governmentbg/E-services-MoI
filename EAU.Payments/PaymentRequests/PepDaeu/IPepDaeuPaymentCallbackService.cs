...
namespace EAU.Payments.PaymentRequests.PepDaeu
{
    ...
    public interface IPepDaeuPaymentCallbackService
    {
        ...
        Task<OperationResult<string>> ProcessNotificationMessageAsync(string registrationDataCin, NotificationMessageTransportRequest message, CancellationToken cancellationToken);
