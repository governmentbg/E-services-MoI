...
namespace EAU.Payments.PaymentRequests.Repositories
{
    ...
    public class PaymentRequestDataContext : BaseDataContext
    {
        ...
        public async Task PaymentRequestUpdateAsync(
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _dbContext.SPExecuteAsync("[pmt].[p_payment_requests_update]", parameters, cancellationToken);
        }

        public async Task PaymentRequestDeleteAsync(long? p_payment_request_id, CancellationToken cancellationToken)
        {
            var parameters = new DynamicParameters();

            parameters.Add("@p_payment_request_id", p_payment_request_id);

            await _dbContext.SPExecuteAsync("[pmt].[p_payment_requests_delete]", parameters, cancellationToken);
        }
