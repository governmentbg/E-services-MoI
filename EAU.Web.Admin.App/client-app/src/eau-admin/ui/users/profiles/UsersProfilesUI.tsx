...
import { EAUBaseComponent, NotificationPanel, NotificationType, Pagination, UserSearchCriteria, UserVM, AuthenticationTypes, ValidationSummaryStrategy, ValidationSummary, ValidationSummaryErrors, UserStatuses } from 'eau-core';
            ...
            if (this.users && this.users.length > 0) {
                ...
                dataResult = (<div className="card">
                    <div className="col-12">
                        <NotificationPanel notificationType={NotificationType.Info} text={"Няма намерени резултати."} />
                    </div>
                </div>);
            }
        }
