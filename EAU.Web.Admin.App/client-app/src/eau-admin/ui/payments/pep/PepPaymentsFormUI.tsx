    ...
    private onSave() {
        ...
        if (this.validators[0].validate(this.model)) {
            if (this.pepID) {
                ...
                this.props.registerAsyncOperation(this.registrationsDataService.updateRegistrationData(this.model).then(() => {
                ...
                this.props.registerAsyncOperation(this.registrationsDataService.addRegistrationData(this.model).then(() => {
