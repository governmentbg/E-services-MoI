...
import { AddUpdateServiceUI, AppParametersUI, AuditUI, Constants, DeclarationFormUI, DeclarationsUI, DocumentTemplateFormUI, DocumentTemplateUI, EpayPaymentsFormUI, HomeUI, LabelsUI, LabelTranslationsUI, LanguagesUI, Layout, LimitsUI, PageNotFoundUI, PepPaymentsFormUI, PepPaymentsUI, PredefinedPagesFormUI, PredefinedPagesI18nFormUI, PredefinedPagesI18nUI, PredefinedPagesUI, RegistrationUI, ServiceGroupFormUI, ServiceGroupTranslateUI, ServiceGroupUI, ServicesI18nFormUI, ServicesI18nUI, ServicesUI, SessionTimeoutUI, UnauthenticatedPageUI, UserProfileFormUI, UsersProfilesUI } from 'eau-admin';
    ...
    return (
        <Layout user={user}>
            <Switch>
                {user ?
                    routes
                    : <Route key={90} component={UnauthenticatedPageUI} />}
            </Switch>
        </Layout>);
}
