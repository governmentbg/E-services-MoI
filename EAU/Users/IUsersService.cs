...
namespace EAU.Users
{
    ...
    public interface IUsersService
    {
        ...
        /// <returns></returns>
        Task<OperationResult<UserRegistrationResult>> BeginPublicUserRegistrationAsync(string email, string password, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">cancellationToken</param>
        /// <returns></returns>
        Task<OperationResult<bool>> RegisterUserCertificateAuthenticationAsync(X509Certificate2 certificate, int currentUserId, IPAddress ipAddress, CancellationToken cancellationToken);
